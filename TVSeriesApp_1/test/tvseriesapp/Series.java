...
public class Series {
    ...
    /**
     * Finds a series by its ID. Re-written to be public for testing.
    ...
    /**
     * A simple method to allow tests to add pre-defined series data.
     * @param series The series model to add to the list.
     */
    ...
    /**
     * A simple getter to allow tests to inspect the contents of the list.
     * @return The internal list of series.
     */
    ...
    /**
     * Logic for validating age, separated into its own method for testing.
     * @param input The user's input string for age.
     * @return True if the age is valid (a number between 2 and 18).
     */
